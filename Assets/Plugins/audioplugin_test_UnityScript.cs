...
public class audioplugin_testGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_test"; } }
    public override string Description    { get { return "audioplugin_test"; } }
    public override string Vendor         { get { return "Juriel G"; } }

    //==============================================================================
	[DllImport("audioplugin_test")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_test")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_test")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_test")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_test")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_test")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_test")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
